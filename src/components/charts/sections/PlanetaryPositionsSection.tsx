  ...
  return (
    <div className="bg-white border border-black border-b-0">
      <div className="flex items-center p-3 sm:p-6 border-b border-black">
        ...
        <h5 className="font-space-grotesk text-base sm:text-lg font-bold text-black">Planetary Positions</h5>
      </div>
      <div className="p-3 sm:p-6">
        {/* Mobile: Single column card layout */}
        <div className="sm:hidden space-y-2">
          {chartData.planets.map((planet) => (
            <div key={planet.name} className="flex items-center justify-between p-3 border border-black hover:bg-gray-50 transition-colors">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="flex items-center">
                    <span className="font-space-grotesk font-medium capitalize text-black text-sm">
                      {planet.name}
                    </span>
