...
export const trackChartGeneration = (chartType: string, metadata?: {
  ...
  event('generate_chart', {
    ...
    value: 1,
    custom_parameter_1: metadata?.isAutoGenerated ? 'auto' : 'manual',
    custom_parameter_2: metadata?.hasCompleteProfile ? 'complete' : 'partial',
    ...metadata
  });
};
