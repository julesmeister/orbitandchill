        ...
        <div className="bg-white border border-black p-4 sm:p-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center justify-between p-2.5 sm:p-3 border border-black">
              <span className="font-open-sans text-xs sm:text-sm text-black">Avg. Response Time</span>
            ...
            <div className="flex items-center justify-between p-2.5 sm:p-3 border border-black">
              <span className="font-open-sans text-xs sm:text-sm text-black">Database Queries</span>
              <span className="font-space-grotesk text-xs sm:text-sm font-bold text-black">
                {healthMetrics?.database.responseTime ? `${healthMetrics.database.responseTime}ms` : '< 50ms'}
              </span>
            </div>
            <div className="flex items-center justify-between p-2.5 sm:p-3 border border-black">
              <span className="font-open-sans text-xs sm:text-sm text-black">Memory Usage</span>
              <span className="font-space-grotesk text-xs sm:text-sm font-bold text-black">
                {healthMetrics?.memory ? `${healthMetrics.memory.percentage.toFixed(1)}%` : '45.2%'}
              </span>
            </div>
            <div className="flex items-center justify-between p-2.5 sm:p-3 border border-black">
              <span className="font-open-sans text-xs sm:text-sm text-black">Active Connections</span>
              <span className="font-space-grotesk text-xs sm:text-sm font-bold text-black">
                {activeUsers || 0}
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4 border border-black" style={{ 
              ...
              <div className="text-center">
                ...
                <div className="font-open-sans text-xs text-black/60">System Status</div>
              </div>
            </div>
            ...
            <div className="p-4 border border-black" style={{ 
              ...
              <div className="text-center">
                ...
                <div className="font-open-sans text-xs text-black/60">Memory Usage</div>
              </div>
            </div>
