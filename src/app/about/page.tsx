        ...
        <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
          <section className="px-6 md:px-12 lg:px-20 py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-black">
              <div className="text-center p-8 border-r border-black" style={{ backgroundColor: '#51bd94' }}>
              ...
              <div className="text-center p-8 border-r border-black" style={{ backgroundColor: '#ff91e9' }}>
                <div className="w-16 h-16 bg-black flex items-center justify-center mx-auto mb-6">
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center p-8" style={{ backgroundColor: '#6bdbff' }}>
                <div className="w-16 h-16 bg-black flex items-center justify-center mx-auto mb-6">
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
