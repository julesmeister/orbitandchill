  ...
  return (
    <div className="bg-white">
      ...
      <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
        <section className="px-4 lg:px-6 xl:px-12 2xl:px-20 py-6 lg:py-12">
                ...
                {categories.map((category) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left px-6 py-4 transition-all duration-200 flex items-center justify-between group relative ${selectedCategory === category
                          ? 'bg-black text-white'
