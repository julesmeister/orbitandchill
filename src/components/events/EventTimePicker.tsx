          ...
          <div className="flex items-center space-x-3">
            {isOptimal && (
              <div className="flex items-center space-x-2 bg-black text-white px-3 py-1.5 border border-black">
                ...
                <span className="font-inter text-sm font-medium">Optimal: {formatTime12Hour(eventTime)}</span>
          ...
          {timeOptions.map((option, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative font-inter text-xs opacity-75">{option.label.split(' - ')[1]}</div>
              </button>
            );
          })}
        </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
          ...
          {isOptimal && (
            <div className="flex items-center space-x-2 text-sm text-black bg-yellow-50 px-3 py-2 border border-black">
              ...
              <span className="font-inter font-medium">Optimal timing based on planetary positions</span>
            </div>
          )}
        </div>
      </div>
