...
// Planetary Aspects to Celestial Points
// ======================================
//
// Covers aspects from traditional planets to celestial points:
// Sun, Moon, Mercury, Venus, Mars, Jupiter, Saturn, Uranus, Neptune, Pluto
// → Lilith, North Node, South Node, Part of Fortune

export const planetaryCelestialPointAspects: Record<
  string,
