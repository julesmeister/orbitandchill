 ...
 * Transit System Data
 * 
 * This module contains all constants, templates, and data related to 
 * astrological transits including orb ranges, planet weights, speeds,
 * and transit advice templates.
 */
...
export interface TransitAdviceTemplate {
  immediate: string[];
  preparation: string[];
  timing: {
    favorable: string[];
