...
export const SEED_PERSONA_TEMPLATES: SeedPersonaTemplate[] = [
  ...
  // Intermediate (5)
  {
    ...
    avatar: '/avatars/enthusiast-1.png',
  ...
  },
  {
    ...
    avatar: '/avatars/moon-mama-1.png',
    subscriptionTier: 'free',
